...
export class UpdateService {
  ...
  /**
   * An alternative way of checking for updates. every 30 seconds.
   * This service method may be called from navigation.component constructor...
   * see subscribeToUpdates method in navigation.component.ts
   */
